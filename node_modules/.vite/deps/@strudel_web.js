...
function EC({
  ...
  }, T = async (oe, W = true) => (oe = o?.(oe) || oe, await L.setPattern(oe, W), oe);
  Ni(() => L.now());
  ...
  return { scheduler: L, evaluate: async (oe, W = true, $e = true) => {
    ...
    try {
      _({ code: oe, pending: true }), await ie(), Ni(() => L.now()), await n?.({ code: oe }), me = [], $e && V(), M && (oe = `mondolang\`${oe}\``);
      ...
      Ue(`[eval] error: ${xe.message}`, "error"), console.error(xe), _({ evalError: xe, pending: false }), t?.(xe);
    }
...
var qd = (e, t, n, r, i) => fa(Ev(e), i, n, r, e.whole?.begin.valueOf());
function Hd(e = {}) {
  return e = {
