import { P as ne, v as q, A as g, B as K, C as re, E as ie, G as se } from "./index-C-fv3oY1.js";
class E {
  /**
  ...
  async _updateInputs() {
    ...
    return this.interface.inputs.forEach((t) => {
      if (!this._inputs.find((n) => n._midiInput === t)) {
        ...
        n || (n = new X(t)), this._inputs.push(n), e.push(n.open());
      }
    }), Promise.all(e);
  }
  /**
...
async function _e(a) {
  ...
  const e = await Z(), t = B(a, c.inputs);
  if (!t)
    throw new Error(
