import { R as x, C as Xt, S as G, T as U1, A as i1, U as gt, V as O1, W as Pm, X as am, Y as Kt } from "./index-C-fv3oY1.js";
function X1(t) {
...
const { transpose: kM, trans: FM } = G(["transpose", "trans"], function(n, m) {
  return m.withHap((e) => {
    const r = e.value.note ?? e.value;
    if (typeof r == "number") {
      let P;
      typeof n == "number" ? P = n : typeof n == "string" && (P = O.semitones(n) || 0);
      const a = r + P;
      return typeof e.value == "object" ? e.withValue(() => ({ ...e.value, note: a })) : e.withValue(() => a);
    }
    if (typeof r != "string" || !U1(r))
      return i1(`[tonal] transpose: not a note "${r}"`, "warning"), e;
    const o = isNaN(Number(n)) ? String(n) : O.fromSemitones(n), M = _.simplify(_.transpose(r, o));
    return typeof e.value == "object" ? e.withValue(() => ({ ...e.value, note: M })) : e.withValue(() => M);
  });
}), { scaleTranspose: OM, scaleTrans: qM, strans: GM } = G(
...
let rm = "ireal";
const wM = (t) => rm = t, BM = (t, n) => xM(t, t1[t].dictionary, n), xM = (t, n, m = ["F3", "A4"]) => {
...
export {
  ...
  zM as scale,
  qM as scaleTrans,
  OM as scaleTranspose,
  wM as setDefaultVoicings,
  BM as setVoicingRange,
  GM as strans,
  FM as trans,
  kM as transpose,
  UM as voicing,
