...
type RouteParams = {  };
type RouteId = '/model/idp-86/operator';
...
type LayoutRouteId = RouteId | "/model/idp-86/operator"
...
export type LayoutData = Expand<Omit<LayoutParentData, keyof Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/idp-86/operator/+layout.js').load>>>> & OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/idp-86/operator/+layout.js').load>>>>>>;
