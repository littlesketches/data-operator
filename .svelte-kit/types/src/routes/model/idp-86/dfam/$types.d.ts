...
type RouteParams = {  };
type RouteId = '/model/idp-86/dfam';
...
type LayoutRouteId = RouteId | "/model/idp-86/dfam"
...
export type LayoutData = Expand<Omit<LayoutParentData, keyof Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/idp-86/dfam/+layout.js').load>>>> & OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/idp-86/dfam/+layout.js').load>>>>>>;
