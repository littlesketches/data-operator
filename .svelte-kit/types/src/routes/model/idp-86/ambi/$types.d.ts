...
type RouteParams = {  };
type RouteId = '/model/idp-86/ambi';
...
type LayoutRouteId = RouteId | "/model/idp-86/ambi"
...
export type LayoutData = Expand<Omit<LayoutParentData, keyof Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/idp-86/ambi/+layout.js').load>>>> & OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/idp-86/ambi/+layout.js').load>>>>>>;
