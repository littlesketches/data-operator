...
type RouteParams = {  };
type RouteId = '/model/ds-87/operator';
...
type LayoutRouteId = RouteId | "/model/ds-87/operator"
...
export type LayoutData = Expand<Omit<LayoutParentData, keyof Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/ds-87/operator/+layout.js').load>>>> & OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/ds-87/operator/+layout.js').load>>>>>>;
