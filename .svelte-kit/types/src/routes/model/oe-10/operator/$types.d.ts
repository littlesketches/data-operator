...
type RouteParams = {  };
type RouteId = '/model/oe-10/operator';
...
type LayoutRouteId = RouteId | "/model/oe-10/operator"
...
export type LayoutData = Expand<Omit<LayoutParentData, keyof Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/oe-10/operator/+layout.js').load>>>> & OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/oe-10/operator/+layout.js').load>>>>>>;
