...
type RouteParams = {  };
type RouteId = '/model/cw-193/ambi';
...
type LayoutRouteId = RouteId | "/model/cw-193/ambi"
...
export type LayoutData = Expand<Omit<LayoutParentData, keyof Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/cw-193/ambi/+layout.js').load>>>> & OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/cw-193/ambi/+layout.js').load>>>>>>;
