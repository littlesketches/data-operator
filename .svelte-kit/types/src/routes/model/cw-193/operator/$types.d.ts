...
type RouteParams = {  };
type RouteId = '/model/cw-193/operator';
...
type LayoutRouteId = RouteId | "/model/cw-193/operator"
...
export type LayoutData = Expand<Omit<LayoutParentData, keyof Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/cw-193/operator/+layout.js').load>>>> & OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/model/cw-193/operator/+layout.js').load>>>>>>;
