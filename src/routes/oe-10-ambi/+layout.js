...
import { DataSonification } from '$lib/module/data-operator/model/oe-10-ambi/DataSonification.svelte.js';

// Config
import { appConfig }        from '$lib/_core/config/app-config';
import { scaleConfig }      from '$lib/module/data-operator/model/oe-10-ambi/config/scale-config.js';
...
import { groupConfig }      from '$lib/module/data-operator/model/oe-10-ambi/config/group-config.js';
import { groupPartPresets } from '$lib/module/data-operator/model/oe-10-ambi/config/part-config.js';
