...
import { DataSonification } from '$src/lib/module/data-operator/model/oe-10/operator/DataSonification.svelte.js';
...
import { scaleConfig }      from '$src/lib/module/data-operator/model/oe-10/operator/config/scale-config.js';
import { groupConfig }      from '$src/lib/module/data-operator/model/oe-10/operator/config/group-config.js';
import { groupPartPresets } from '$src/lib/module/data-operator/model/oe-10/operator/config/part-config.js';
