    ...
    <div class = 'content-wrapper'>
        ...
        <section>
            ...
            <ul>
                ...
                <li>The sonification approach of <strong>parameter mapping</strong> is fixed, with customisation both possible and encouraged for each distinct <i>Data Operator</i> model and version<label for="sn-015" class="margin-toggle sidenote-number"></label><input type="checkbox" id="sn-015" class="margin-toggle"/><span class="sidenote">Parameter mapping customisation extends to instrument design (in Strudel) and UI styling (in 'themes' and key controls). The upshot is the that the look, feel and sound of each <i>Data Operator</i> model/version can be unique, while maintaining standard instrument controls.</span>. Specific details about each sonificaiton are provided as documentation alongside each <i>Data Operator</i>.
