...
<article class:isSideGuide={isSideGuide} in:fade>
    <div class = 'content-wrapper' >
        ...
        <section>
            ...
            <p>The CW-193:AMBI features the conventional set of <i>Data Operator</i> tracks, with a lead synth (on track A), bass synth (B), two drum kit layers (C1 and C2) and a chord instrument (C3).</p>
