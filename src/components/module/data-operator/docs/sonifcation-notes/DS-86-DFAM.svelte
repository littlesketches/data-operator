...
<article class:isSideGuide={isSideGuide} in:fade>
    <div class = 'content-wrapper' >
        ...
        <section>
            ...
            <p>The DS-86:DFAM uses a multi-voice synth setup whose voices are controlled across track A and B; in addition to two drum kit layers (C1 and C2) and a chord instrument (C3). The synth is a (very imperfect) version of the <a href = 'https://www.moogmusic.com/synthesizers/dfam/' target = '_blank'>Moog DFAM </a>.</p>
            <ul>
