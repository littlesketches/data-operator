...
export class DataSonification extends Sonification{
    ...
    updateParameterMap(init = false){
        ...
        if(init){
            ...
            this.state.selection.group.A.pitchPattern = randomA
            this.state.selection.group.B.pitchPattern = randomB
        ...
        const sceneData = this.data.scene[this.state.selection.sceneIndex],
            ...
            group = {
                ...
                B: {
                    ...
                    noise:    { interval: this.schema.group.B.map.noise.interval    },
                    sub:      { interval: this.schema.group.B.map.sub.interval    }
                },
        ...
        group.B.pitch.series = group.B.noise.series = group.B.sub.series = group.C["2"].velocity.series = group.C["3"].series = this.state.selection.group.B.pitchPattern


        /**
         *  GROUP A: Melodic instrument (piano)
         */ 
