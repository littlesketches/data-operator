...
export class DataSonification extends Sonification{
    ...
    updateParameterMap(init = false){
            ...
            group = {
                ...
                B: {
                    ...
                    noise: {
                        ...
                        series:     'ratio-fossil',          // Static/config interval
        ...
        group.A.pitch.array = dayData.scaledData[group.A.pitch.interval].A.pitch.map(d => { return d[group.A.pitch.series][scaleLock]})
